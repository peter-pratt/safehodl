import { IEntryPoint__factory, SimpleAccountFactory__factory, SimpleAccount__factory } from "@safehodl/types/src/executor/contracts"
...
export async function createRandomUnsignedUserOp(
  ...
  const maxFeePerGas = 1; // TODO: fetch gas prices from safehodlService
